...
import ayiacademy.tp2.ejercicio2backend.persistence.repositories.UsuariosRepository;
...
public class UsuariosServiceImpl implements UsuariosService {
  ...
  public boolean validateUser(Usuario usuario) {
    return usuariosRepository.findAllByNombreUsuario(usuario.getNombreUsuario()).stream()
        .anyMatch(
            otherUsuario -> otherUsuario.getPasswordUsuario().equals(usuario.getPasswordUsuario()));
  }
}
